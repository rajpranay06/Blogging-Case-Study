...
public class Blogger{
	...
	@JoinTable(name = "blogger_and_communities", joinColumns = { @JoinColumn(name = "userId") }, inverseJoinColumns = {
  ...
  /*  //OneToMany-One Blogger can have many posts
	...
	@ManyToMany(cascade = CascadeType.MERGE)
	@JoinTable(name = "blogger_and_award", joinColumns = { @JoinColumn(name = "userId") }, inverseJoinColumns = {
