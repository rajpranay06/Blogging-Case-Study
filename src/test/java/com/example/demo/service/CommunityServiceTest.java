...
public class CommunityServiceTest {
	...
	void updateCommunityTest()
	{
		...
		//Validate details
		assertEquals(127,c.getCommunityId());
	...
	{
		List<CommunityOutputDto> comList = comServ.listAllCommunitiesByDescription("Movie Box");
	...
	{	
		CommunityOutputDto com = comServ.getCommunityByPostId(121);
		
		assertEquals(126,com.getCommunityId());
		assertEquals("Movie Box",com.getCommunityDescription());
		assertEquals(45,com.getTotalMembers());
